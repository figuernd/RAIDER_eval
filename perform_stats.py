...
def repeat_bounds_generator(rep_file):
    rf = open(rep_file, 'r')
    rf.readline()
    rf.readline()
    rf.readline()
...
def main(seq_file, real_repeats, masker_output, output_file, print_reps):
    ...
    real_bounds_generator = repeat_bounds_generator(real_repeats)
    gen_bounds_generator = repeat_bounds_generator(masker_output)
