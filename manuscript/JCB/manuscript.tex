...
We see in the attached table the pseudocode for the phRAIDER
algorithm, used to find a sequence descriptor for each set of
sequences that comprise an elementary repeat family with respoect to
some fixed seed $s$ and minimum frequency threshold $f$.  We see see
the core components of this algorithm as:
\begin{itemize}
\item 
