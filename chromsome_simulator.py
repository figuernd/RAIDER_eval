...
def parse_params(args):
    ...
    parser.add_argument('--rn', '--retain_n', dest = "retain_n", action = 'store_true', help = "If used, will the whole chromosome.  Otherwise, cuts of Ns at either end.", default = False)
...
def generate_chromosome(seq, markov_list, coord_adjust, rpt_gen, mask = False, max_interval = None, num_repeats = None, max_length = None):
    """
